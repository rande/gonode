    ...
    render: function () {
        return (
            <div className="notification-element">
                <Router.Link to="gonodes.edit" params={{uuid: this.props.subject}}>{this.props.name}</Router.Link>
                <br />
        ...
        return (
            <B.Col md={6}>
                <div className="card">
                    ...
                    <Router.Link to="gonodes.edit" params={node}>{node.name ? node.name : node.uuid}</Router.Link>
                    <br />
