...
var config = {
    ...
    // you also need to set variable to make inner import work properly:
    //    # file main.scss
    ...
    // we use path.join to make it work cross platform
    ...
    module: {
        ...
        loaders: [{
            ...
            loader: process.env.NODE_ENV == 'production' ?
                ...
                // without this plugin css will be store as a variable inside the final
                // bundle file
                ExtractTextPlugin.extract('css!resolve-url!less') :

                // the style loader is usefull to load the style inline with WebpackDevServer
                'style!css!resolve-url!less'
        }, {
            // match woff fonts
