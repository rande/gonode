...
func Configure(l *goapp.Lifecycle, conf *config.Config) {
	...
	l.Prepare(func(app *goapp.App) error {
		...
		mux.Get(conf.Api.Prefix+"/:version/nodes/:nid", Api_GET_Node(app))
		mux.Get(conf.Api.Prefix+"/:version/nodes/:nid/revisions", Api_GET_Node_Revisions(app))
		mux.Get(conf.Api.Prefix+"/:version/nodes/:nid/revisions/:rev", Api_GET_Node_Revision(app))
		mux.Post(conf.Api.Prefix+"/:version/nodes", Api_POST_Nodes(app))
		mux.Put(conf.Api.Prefix+"/:version/nodes/:nid", Api_PUT_Nodes(app))
		mux.Put(conf.Api.Prefix+"/:version/nodes/move/:nid/:parentNid", Api_PUT_Nodes_Move(app))
		mux.Delete(conf.Api.Prefix+"/:version/nodes/:nid", Api_DELETE_Nodes(app))
